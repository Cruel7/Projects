...
def predict_step(image_paths):
    ...
    for image_path in tqdm(image_paths, desc='Generating captions'):
        try:
            ...
            print(colored(f'Error generating caption for image {image_path}: {e}', "red"))
            continue
    return captions
...
with open(file_path, "w") as jsonl_file:
    for caption, image_path in zip(generated_captions, image_paths):
        print(colored("Image: {image_path}", "yellow"))
        print(colored("Caption: {caption}", "green"))
        print()
        ...
        try:
            ...
            print(colored(f'Error writing to JSONL file for image {image_path}: {e}', "red"))
            continue

print(colored("Image data and captions converted and saved to JSONL file successfully.", "green"))
