...
output_dir = "/home/gkirilov/Brand_new_PC/automation_test_2/dreambooth"
resolution = 512
batch_size_list = [1]
    ...
    for lr in learning_rate_list:
        for steps in max_train_steps_list:
            for batch_size in batch_size_list:
                ...
                print("Time for training with max_train_steps =", steps, ", learning_rate =", lr, ", batch_size =", batch_size, ":", training_time, "seconds")

                with open(f"{log_dir}/log_jenna_1024.txt", "a") as log_file:
                    log_file.write(f"Model: {unique_output_dir}, Time for training with max_train_steps = {steps}, learning_rate = {lr}, batch_size = {batch_size}: {training_time} seconds\n")
