...
instance_data_dir = "/home/gkirilov/Checkpoint/jenna_mix"
output_dir = "/home/gkirilov/Brand_new_PC/jenna_mix/dreambooth"
instance_prompt = "JENNALBA"
resolution = 512
batch_size = 1
...
lr_warmup_steps = 0
max_train_steps_list = [400, 800, 1200, 1600, 2000, 2500, 3000, 4000, 5000]
    ...
    for model_name, model_info in models.items():
        if model_info["active"]:
            ...
            for main_prompt in [
                ...
                image.save(out_dir + short_prompt + "_JORTEGAbig_512.png")
                ...
                image.save(out_dir + short_prompt + "_JORTEGAbig_768.png")
                ...
                image = pipe_img2img(prompt=prompt, guidance_scale=8, image=image, strength=0.55,
                                     negative_prompt=negative).images[0]
                image.save(out_dir + short_prompt + "_JORTEGAbig_1024.png")
...
for lr in learning_rate_list:
    for steps in max_train_steps_list:
        ...
        with open(f"{log_dir}log2.txt", "a") as log_file:
            log_file.write(
