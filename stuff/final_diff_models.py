...
def accelerate_conf(max_train_steps, learning_rate, batch_size, unique_output_dir):
    accelerate_command = [
        "accelerate",
        "launch",
        "train_dreambooth.py",
...
pretrained_models = ["/home/gkirilov/models/Dreamshaper/dreamshaper_6BakedVae",
                     "/media/gkirilov/Storage/huggingface/hub/models--SG161222--Realistic_Vision_V1.4/snapshots/6e02ccb36bd0d45ec803cd58cd61f7e7edaff39f",
                     "/media/gkirilov/Storage/huggingface/hub/models--nitrosocke--redshift-diffusion-768/snapshots/30b5fd6173c924f9d63a205efd505843938d672d",
                     "/media/gkirilov/Storage/huggingface/hub/models--stabilityai--stable-diffusion-2-1/snapshots/36a01dc742066de2e8c91e7cf0b8f6b53ef53da1",
                     "/media/gkirilov/Storage/huggingface/hub/models--dreamlike-art--dreamlike-photoreal-2.0/snapshots/d9e27ac81cfa72def39d74ca673219c349f0a0d5"]


instance_data_dir = "/home/gkirilov/Brand_new_PC/images"
output_dir = "/home/gkirilov/Brand_new_PC/dreambooth/dreambooth"
instance_prompt = "a photo of JENNAORTEGAX"
resolution = 512
batch_size = 1
gradient_accumulation_steps = 1
learning_rate_list = [5e-6, 4e-6, 3e-6, 2e-6]
lr_scheduler = "constant"
lr_warmup_steps = 0
max_train_steps_list = [400, 600, 800, 1000]
...
for pretrained_model in pretrained_models:
    for lr in learning_rate_list:
        for steps in max_train_steps_list:
            ...
            accelerate_conf(steps, lr, batch_size, unique_output_dir)
            end_time = time.time()
            accelerate_conf_time = end_time - start_time
            print("Time for accelerate_conf with max_train_steps =", steps, ", learning_rate =", lr, ", batch_size =",
                  batch_size, ":", accelerate_conf_time, "seconds")

            # Log accelerate_conf time
            with open(f"{log_dir}log.txt", "a") as log_file:
                log_file.write(
                    f"Time for accelerate_conf with max_train_steps = {steps}, learning_rate = {lr}, batch_size = {batch_size}: {accelerate_conf_time} seconds\n")
